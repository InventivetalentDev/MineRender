...
import { BoxGeometryCacheKey } from "./cache/CacheKey";
...
export class Geometries {
    ...
    public static createBox(key: BoxGeometryCacheKey): BoxGeometry {
    ...
    public static getBox(key: BoxGeometryCacheKey): BoxGeometry {
        return Caching.getBoxGeometry(key);
    }
